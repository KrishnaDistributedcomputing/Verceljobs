...
**Part I: Role & Platform Foundation**
...
**Part II: Build, Deploy & Serve**
3. [The Build Pipeline & Deployment Model](#3--the-build-pipeline-deployment-model)
4. [Preview Deployments](#4--preview-deployments)
5. [Compute — The Three Runtimes](#5--compute-the-three-runtimes)
6. [Fluid Compute — The 2025 Game Changer](#6--fluid-compute-the-2025-game-changer)
7. [Edge Network & CDN](#7--edge-network-cdn)

**Part III: Next.js Framework Mastery**
8. [Next.js Rendering Strategies](#8--nextjs-rendering-strategies)
9. [Caching — The Most Important Topic](#9--caching-the-most-important-topic)
10. [Middleware & Routing](#10--middleware-routing)
11. [Core Web Vitals — What You Must Know](#11--core-web-vitals-what-you-must-know)

**Part IV: Platform Services**
12. [Edge Config & KV Storage](#12--edge-config-kv-storage)
13. [Observability — Speed Insights, Web Vitals, Logs](#13--observability-speed-insights-web-vitals-logs)
14. [Security — WAF, DDoS, Access Control](#14--security-waf-ddos-access-control)

**Part V: AI Cloud**
15. [The AI Cloud Layer](#15--the-ai-cloud-layer)

**Part VI: Architecture & Business**
16. [Composable Architecture & Headless Integrations](#16--composable-architecture-headless-integrations)
17. [Common Customer Architectures](#17--common-customer-architectures)
18. [Migration Patterns](#18--migration-patterns)
19. [Pricing Model — In Depth](#19--pricing-model-in-depth)
